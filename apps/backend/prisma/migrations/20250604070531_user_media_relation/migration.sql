...
INSERT INTO "new_User" ("createdAt", "dayOfWeekId", "email", "homeDashboard", "id", "languageId", "name", "password", "pseudo", "refreshToken", "resetPasswordRequested", "updatedAt") SELECT "createdAt", "dayOfWeekId", "email", "homeDashboard", "id", "languageId", "name", "password", "pseudo", "refreshToken", "resetPasswordRequested", "updatedAt" FROM "User";
DROP TABLE "User";
